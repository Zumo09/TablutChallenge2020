...
import giordani.tabzai.player.brain.kernel.KernelGen;
...
public class BrainGenetic extends Brain {
...
//						System.out.println("\t\t" + a + " (" + ev + ")");
	...
	public static Brain load(int timeout, int gametype) {
		Brain brain = new BrainGenetic(timeout, gametype);
